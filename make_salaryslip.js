...
const fullFile = `import React, { useState, useRef } from 'react';
...
export function SalarySlipManager({ teachers, slips, setSlips }: SalarySlipProps) {
...
`;
fs.writeFileSync('src/components/SalarySlip.tsx', fullFile);
